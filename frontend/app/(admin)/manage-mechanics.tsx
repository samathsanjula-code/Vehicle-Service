                ...
                <View style={styles.cardHeader}>
                  ...
                  <View style={styles.actions}>
                    <TouchableOpacity
                      ...
                      onPress={() => setEditingMechanic({ ...mechanic })}
                    >
                      <Ionicons name="pencil" size={18} color="#2563eb" />
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[styles.actionBtn, { backgroundColor: "#fee2e2" }]}
                      onPress={() => handleDelete(mechanic._id)}
                    >
                ...
                <View style={styles.detailsRow}>
                  ...
                  <View style={styles.detailItem}>
                    ...
                    <Text style={styles.detailText}>
                      {mechanic.level} • {mechanic.experience}
                    </Text>
                  </View>
                </View>
            ...
            {editingMechanic && (
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TextInput
                  ...
                  onChangeText={(t) =>
                    setEditingMechanic({ ...editingMechanic, name: t })
                  }
                />
                ...
                <TextInput
                  ...
                  onChangeText={(t) =>
                    setEditingMechanic({ ...editingMechanic, phone: t })
                  }
                ...
                <TextInput
                  ...
                  onChangeText={(t) =>
                    setEditingMechanic({ ...editingMechanic, experience: t })
                  }
                />
                ...
                <View style={styles.buttonRow}>
                  {["Junior", "Senior", "Expert"].map((lvl) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.radioBtn,
                        editingMechanic.level === lvl && styles.radioBtnActive,
                      ]}
                      onPress={() =>
                        setEditingMechanic({ ...editingMechanic, level: lvl })
                      }
                    >
                      <Text
                        style={[
                          styles.radioText,
                          editingMechanic.level === lvl &&
