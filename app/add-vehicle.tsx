    ...
    try {
      const payload = {
        ...
        serviceDetails: {
          ...
          issueDescription,
          images, // In a real app, you'd upload these to S3/Cloudinary first
        },
      };
      ...
      if (response.ok) {
        Alert.alert(
          'Success',
          'Your service request has been saved to the database!',
      ...
      >
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <View>
              <ThemedText type="title" style={styles.title}>Service Request</ThemedText>
              <Text style={styles.subtitle}>Register vehicle & book service</Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <ThemedText type="defaultSemiBold" style={styles.sectionTitle}>Vehicle Details</ThemedText>
            </View>
